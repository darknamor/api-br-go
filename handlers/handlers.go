...
func responseMovie(w http.ResponseWriter, status int, results interfaces.Movie) {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
	json.NewEncoder(w).Encode(results)
}

func responseMovies(w http.ResponseWriter, status int, results []interfaces.Movie) {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
	json.NewEncoder(w).Encode(results)
}
...
func MovieAdd(w http.ResponseWriter, r *http.Request) {
	...
	var movie_data interfaces.Movie
